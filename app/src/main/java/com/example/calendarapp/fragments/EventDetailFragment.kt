...
import com.example.calendarapp.data.CalDAVSync
...
class EventDetailFragment : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(eventId: String? = null): EventDetailFragment {
    ...
    private fun loadCalendars() {
        lifecycleScope.launch {
            try {
                availableCalendars = calDavSync.getAvailableCalendars()
                setupCalendarDropdown()
            } catch (e: Exception) {
                println("Error loading calendars: ${e.message}")
                // Create a default calendar option
    ...
    private fun saveEvent() {
        ...
        println("Selected Calendar: ${selectedCalendar!!.displayName} (ID: ${selectedCalendar!!.id})")
        println("Calendar URL: ${selectedCalendar!!.url}")
        ...
        println("Event Calendar ID: '${event.calendarId}'")
        println("Event Calendar Name: '${event.calendarName}'")
